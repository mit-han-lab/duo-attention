...
sparsity=0.5
attn_pattern="attn_patterns/Llama-3-8B-Instruct-Gradient-1048k"
...
sparsity=0.75
attn_pattern="attn_patterns/Llama-2-7B-32K-Instruct"
attn_pattern="attn_patterns/Llama-2-7B-32K-Instruct/lr=0.02-reg=0.05-ctx=1000_32000-multi_passkey4"
attn_pattern="outputs/Llama-2-7B-32K-Instruct/lr=0.02-reg=0.05-ctx=1000_32000-multi_passkey4"
